    ...
    children: [
      {
        ...
        name: 'Identity',
        meta: { title: '标识管理', icon: 'identity', roles: ['admin', 'editor'] }
      },
      {
        path: 'profile',
    ...
    children: [
      {
        ...
        name: 'MachineIndex',
        meta: { title: '设备列表', icon: 'machine', roles: ['admin', 'editor'] }
      },
      {
        path: 'profile',
    ...
    children: [
      {
        ...
        name: 'Identity',
        meta: { title: '企业管理', icon: 'company', roles: ['admin', 'editor'] }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: 'Identity',
        meta: { title: '证书管理', icon: 'certificate', roles: ['admin', 'editor'] }
      }
    ]
  },
